...
local Window = OrionLib:MakeWindow({Name = "TPTest Hub", HidePremium = false, IntroText = "TPTest Library", SaveConfig = true, ConfigFolder = "TPTest Hub"})
